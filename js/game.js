...
const textNodes = [
  ...
  // SCENE 3
  {
    ...
    options: [
      ...
      {
        text: 'Perguntar o que ele sabe sobre A Substância <strong>L4-Q20</strong>',
        nextText: 4,
  ...
  {
    id: 5,
    text: `<p class="txt animate__animated animate__fadeIn">O Velho Barman explica que A Substância <span class="var">L4-Q20</span> não é produzida há mais de 300 anos, antes dos rumores sobre A Guerra Iminente, e que provavelmente esse frasco veio parar nesse exato buraco no Limiar da Galáxia por meio de Contrabando Sônico &mdash; uma espécie de Viagem no Tempo. Suas propriedades são desconhecidas já que sua principal pesquisadora, a <span class="var">Dra. Y.Suzuki</span>, desapareceu logo após a descoberta. Ele muda de feição repentinamente e pede para ver A Substância mais de perto, as luzes do bar começam a piscar bizarramente.<span class="cursor-blink">|</strong></p>`,
    img: '<img class="img" src="./img/ph.jpg" alt="copyright Daniel Hogrefe" />',
    options: [
      {
